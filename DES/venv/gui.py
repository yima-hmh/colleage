...
def creatGUI():
    ...
    # -*- coding: utf-8 -*-
    """
    Created on Sat Oct 24 20:43:37 2020

    @author: hp
    """

    # 统一按照字符串处理，输入字符串输出也是字符串。
    def IP(Mingwen):
    ...
    nlabel = Label(frmb, relief=RIDGE, text='班级：网络工程2班 姓名：郑光宇 学号：3120004768', font=("微软雅黑", 10))
    nlabel.grid(row=0, column=1, padx=30, ipadx=10, ipady=5)
